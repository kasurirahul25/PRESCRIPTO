  ...
  <div className="space-y-6">
    ...
    <div>
      ...
      <textarea
        ...
        className="w-full h-10 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 resize-none"
        required
      />
    </div>
  </div>
...
{step === 4 && (
  <div className="flex flex-col items-center">
    <h2 className="text-2xl font-semibold text-gray-800 mb-4">
      After 1 hour your prescription will be ready. 
    </h2>
  ...
  <div className="flex items-center col-span-2">
    <span className="font-semibold w-28">BP</span>
    <span className="flex-1 border-b border-gray-400">
